// دوال تحقق من صحة بيانات الزبون قبل إرسال الطلب.
// نفس القواعد مطبّقة أيضاً في الباك إند (backend/utils/validators.js)
// حتى لو تخطى حد التحقق من الفرونت إند، الباك إند يرفض الطلب برضو.
...
// يتحقق من الحقول الثلاثة مرة واحدة، ويرجع كائن أخطاء (فارغ = كل شي صحيح)
export function validateOrderForm({ customerName, phone, address }) {
  const errors = {};
